    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Minus(int cartId)
        {
            ...
            if (cart.Count <= 1)
            {
                ...
                HttpContext.Session.SetInt32(SD.SessionCart, _unitOfWork.ShoppingCart.GetAll(u => u.ApplicationUserId == cart.ApplicationUserId).ToList().Count-1);
            }
            else
            {
        ...
        public IActionResult Remove(int cartId)
        {
            ...
            _unitOfWork.ShoppingCart.Delete(cart);
            _unitOfWork.Save();
            HttpContext.Session.SetInt32(SD.SessionCart, _unitOfWork.ShoppingCart.GetAll(u => u.ApplicationUserId == cart.ApplicationUserId).ToList().Count);
            return RedirectToAction(nameof(Index));
        }
